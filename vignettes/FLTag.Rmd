...
recs <- data.frame(recoveries[,c("specimenid","ctcode1","speciescode","recovery_date","latitude","longitude","len")])
dimnames(recs)[[2]][4] <- 'date'

rels <- data.frame  (releases[,c("specimenid","ctcode1","speciescode","release_date","latitude","longitude","len")])
